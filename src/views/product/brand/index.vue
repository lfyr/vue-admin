      ...
      >
        ...
        <el-form-item label="品牌LOGO" prop="logo" label-width="100px">
          <el-upload
            ...
            :action="baseUrl + '/common/file/fileUpload'"
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        logo: [{ required: true, message: "请选择品牌图片" }],
      },
    };
  },
  mounted() {
    ...
    addOrUpdateBrand() {
      this.$refs.ruleForm.validate(async (success) => {
        if (success) {
          ...
          // 发请求（添加品牌|修改品牌）
          let result = await this.$API.brand.reqAddOrUpdateBrand(
            this.brandFrom
          );
          if (result.code === 0) {
            // 弹出信息
