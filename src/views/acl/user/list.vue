<template>
  <div class="app-container" style="margin: 10px 0px">
    <el-form inline>
      <!-- 表单元素 -->
      <el-form-item>
    ...
    >
      <el-form label-width="80px">
        <el-form-item label="用户名">
          <el-input disabled :value="user.user_name"></el-input>
        </el-form-item>
...
// vue.filter("created_at",function(value.pattern="YYYY-MM-DD")){
  ...
  methods: {
    ...
    */
    async getRoles() {
      ...
      this.userRoleIds = assignRoles.map((item) => item);
    ...
    */
    async getUsers(page = 1) {
      ...
      if (result.code === 0) {
        ...
        this.users = list.filter((item) => item.user_name !== "admin");
        this.users.map((item) => {
